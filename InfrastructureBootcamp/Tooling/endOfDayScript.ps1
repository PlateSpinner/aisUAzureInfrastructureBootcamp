#Upload subscription information to instructors' storage account
...
$userFileName = ("day01_subscriptionInfo_" + $username + "_" + (Get-Date -UFormat %Y%m%d%H%M%S) + ".json")
$userFilePath = Join-Path -Path $env:TMP -ChildPath $userFileName
#Convert context information to JSON
$ctxJson = $ctx | Select-Object @{l="AccountId";e={$_.Account.Id}}, @{l="SubscriptionName";e={$_.Subscription.Name}}, @{l="SubscriptionId";e={$_.Subscription.Id}}, @{l="TenantId";e={$_.Tenant.Id}} | ConvertTo-Json
